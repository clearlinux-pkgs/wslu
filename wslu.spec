...
Version  : 4.1.0
Release  : 2
URL      : https://github.com/wslutilities/wslu/archive/v4.1.0/wslu-4.1.0.tar.gz
Source0  : https://github.com/wslutilities/wslu/archive/v4.1.0/wslu-4.1.0.tar.gz
...
%prep
%setup -q -n wslu-4.1.0
cd %{_builddir}/wslu-4.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672204876
